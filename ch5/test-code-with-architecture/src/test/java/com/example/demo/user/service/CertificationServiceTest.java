...
public class CertificationServiceTest {
  ...
  public void 이메일과_컨텐츠가_제대로_만들어져서_보내지는지_테스트한다(){
    ...
    // when
    certificationService.send("chrismhy1027@naver.com", 1, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");

    // then
    assertThat(fakeMailSender.email).isEqualTo("chrismhy1027@naver.com");
    assertThat(fakeMailSender.title).isEqualTo("Please certifiy your email address");
